    ...
    <main>
      ...
      <section className="limitar-secao secao-cards-sabores">
        ...
        <div className="container-cards">
          ...
          <div className="box-card">
            <img src="./assets/sabor-cookies-avela.png" alt='sorvete sabor avela' />
            <div>
          ...
          <div className="box-card">
            <img src="./assets/sorbet-kiwi.png" alt='sorvete sabor kiwi' />
            <div>
          ...
          <div className="box-card">
            <img src="./assets/sorbet-morango.png" alt='sorvete sabor morango' />
            <div>
          ...
          <div className="box-card">
            <img src="./assets/sorbet-limao.png" alt='sorvete sabor limao' />
            <div>
